...
cat > 'ROADMAP.md' << 'FILEEOF_ROADMAP'
...
FILEEOF_ROADMAP
echo "✅ ROADMAP.md written"
git add ROADMAP.md
git commit --no-gpg-sign -m "docs: add modernization roadmap — 6 phases, issue tracking, progress matrix" || echo "Nothing to commit"
