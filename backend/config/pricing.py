...
PRICING: dict[str, dict[str, float]] = {
    ...
    # DeepSeek
    "deepseek-r1": {"input_per_1m": 0.14, "output_per_1m": 0.28},
    "deepseek-v3": {"input_per_1m": 0.07, "output_per_1m": 0.14},
    # Groq (Llama)
    ...
    "llama-4-8b": {"input_per_1m": 0.0, "output_per_1m": 0.0},
    "llama-4-70b": {"input_per_1m": 0.0, "output_per_1m": 0.0},
    "llama-4-405b": {"input_per_1m": 0.0, "output_per_1m": 0.0},
    "llama-4-scout-17b-16e-instruct": {"input_per_1m": 0.0, "output_per_1m": 0.0},
    "llama-4-maverick-17b-128e-instruct": {"input_per_1m": 0.0, "output_per_1m": 0.0},
    "llama-4-scout": {"input_per_1m": 0.0, "output_per_1m": 0.0},
}
