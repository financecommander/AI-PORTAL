          ...
          >
            ...
            {prov.models.map((m) => {
              ...
              return (
                ...
                >
                  {m.tier === 'top' ? (
                    <Sparkles style={{ width: '14px', height: '14px', color: accent, flexShrink: 0 }} />
                  ) : (
                    <Zap style={{ width: '14px', height: '14px', color: '#8899AA', flexShrink: 0 }} />
                  )}
              ...
              <div key={prov.id}>
                ...
                {prov.models.map((m) => {
                  ...
                  return (
                    ...
                    >
                      {m.tier === 'top' ? (
                        <Sparkles style={{ width: '13px', height: '13px', color: accent, flexShrink: 0 }} />
                      ) : (
                        <Zap style={{ width: '13px', height: '13px', color: '#667788', flexShrink: 0 }} />
                      )}
                      <span
                        style={{
                          flex: 1,
