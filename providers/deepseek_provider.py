"""DeepSeek provider implementation for FinanceCommander AI Portal."""
...
class DeepSeekProvider(BaseProvider):
    """DeepSeek API provider supporting DeepSeek models."""
    ...
    async def send_message(
        ...
        **kwargs
        ...
        try:
            ...
            raise ProviderAPIError("deepseek", e.status_code or 500, str(e)) from e
        except Exception as e:
            raise ProviderAPIError("deepseek", 500, str(e)) from e
    ...
    async def stream_message(
        ...
        **kwargs
        ...
        """Yield response chunks as they arrive from DeepSeek."""
    ...
    def format_attachment(self, attachment: ChatAttachment) -> dict:
        """Format attachment for DeepSeek API.
